...
import '../home_page_appoiments/home_page_appoiments_widget.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class AppointmentAgreed2Widget extends StatefulWidget {
  const AppointmentAgreed2Widget({
    Key key,
    this.dataToAppointment,
  }) : super(key: key);

  final DocumentReference dataToAppointment;

  @override
  _AppointmentAgreed2WidgetState createState() =>
      _AppointmentAgreed2WidgetState();
}

class _AppointmentAgreed2WidgetState extends State<AppointmentAgreed2Widget> {
        ...
        children: [
          ...
          Expanded(
            child: StreamBuilder<TodosRecord>(
              stream: TodosRecord.getDocument(widget.dataToAppointment),
              builder: (context, snapshot) {
                // Customize what your widget looks like when it's loading.
                if (!snapshot.hasData) {
                  return Center(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            final toDoListCreateData = createToDoListRecordData(
                              displayDoctor: mainContentTodosRecord.displayName,
                              displayUser: currentUserDisplayName,
                              time: mainContentTodosRecord.time,
                              displaySpeciality:
                                  mainContentTodosRecord.medicalSpeciality,
                            );
