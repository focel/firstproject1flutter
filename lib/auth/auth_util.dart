...
DocumentReference get currentUserReference => currentUser?.user != null
    ? MedicalUsersRecord.collection.doc(currentUser.user.uid)
    : null;

MedicalUsersRecord currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : MedicalUsersRecord.getDocument(
                  MedicalUsersRecord.collection.doc(uid))
              .handleError((_) {}),
    )
