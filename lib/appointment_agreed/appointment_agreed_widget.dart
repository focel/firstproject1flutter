...
class AppointmentAgreedWidget extends StatefulWidget {
  const AppointmentAgreedWidget({
    Key key,
    this.toDoNote,
  }) : super(key: key);
  ...
  @override
  _AppointmentAgreedWidgetState createState() =>
      _AppointmentAgreedWidgetState();
}

class _AppointmentAgreedWidgetState extends State<AppointmentAgreedWidget> {
